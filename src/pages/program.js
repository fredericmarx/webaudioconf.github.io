...
const program = {
  ...
  demos: [
    ...
    { authors: "Anthony T. Marasco and Jesse Allison", title: "SoundSling: A Framework for Using Creative Motion Data to Pan Audio Across a Mobile Device Speaker Array" },
    ...
    { authors: "Oscar Mayor, Jordi Janer, Hector Parra and Álvaro Sarasúa", title: "VOICEFUL: Voice Analysis, Transformation and Synthesis on the Web" },
  ...
  posters: [
    ...
    { authors: "Johan Pauwels and Mark Sandler", title: "pywebaudioplayer: Bridging the gap between audio processing code in Python and attractive visualisations based on web technology" },
